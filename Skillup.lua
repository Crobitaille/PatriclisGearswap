...
user_settings = {
    user_spells = {
        Healing = T{},
        Geomancy = T{'Indi-Poison', 'Indi-Voidance', 'Indi-Precision', 'Indi-Regen', 'Indi-Attunement'},
        Enhancing = T{},
        Ninjutsu = T{},
        Singing = T{"Army's Paeon", "Army's Paeon II", "Mage's Ballad", "Mage's Ballad III", "Knight's Minne", 
        "Knight's Minne II", "Valor Minuet", "Valor Minuet II", "Knight's Minne", "Knight's Minne II" ,
        "Advancing March", "Sheepfoe Mambo", "Sword Madrigal",},
        Blue = T{},
        Summoning = T{}},
...
sets.brd = {
    ...
    string_inst = {
        range="Langeleik"},}--put your string instrument here
sets.Idle = {
